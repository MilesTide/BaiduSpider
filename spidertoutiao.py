...
start_url = 'https://www.toutiao.com/api/pc/feed/?category=news_finance&utm_source=toutiao&widen=1&max_behot_time='
...
def main(max_behot_time, title, source_url, s_url, source, media_url):  # 主函数
    for i in range(3):  # 此处的数字类似于你刷新新闻的次数，正常情况下刷新一次会出现10条新闻，但也存在少于10条的情况；所以最后的结果并不一定是10的倍数
